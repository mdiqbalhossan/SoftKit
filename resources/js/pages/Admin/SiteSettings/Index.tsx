...
function SiteSettingsIndex(props: { settings: Settings; timezones: string[] }) {
    ...
    const logoPreview = form.data.remove_logo
        ? null
        : (settings.logo_url ?? null);
    const faviconPreview = form.data.remove_favicon
        ? null
                                ...
                                <Card className="mb-4">
                                    <Card.Header className="border-0">
                                        ...
                                        <p className="text-muted mb-0 small">
                                            ...
                                            placeholder), right-side credit,
                                            profile URLs, and app timezone.
                                        </p>
                                    </Card.Header>
                                    <Card.Body>
                                        <Row>
                                        ...
                                        <p className="text-muted small mb-3">
                                            Full URLs (https://…). Icons appear
                                            in the footer when set.
                                        </p>
                                        <Row className="g-3">
                                            <Col md={6}>
