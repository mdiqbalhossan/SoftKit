      ...
      <div className="page-content">
              ...
              <Card>
                <Card.Header className="border-0">
                  <Row className="align-items-center gy-3">
                    <Col>
                      <h5 className="card-title mb-0">Access roles</h5>
                      <p className="text-muted mb-0 small">
                        Short edits in the drawer. Open a role for the long description and roster.
                      </p>
                    </Col>
                    <Col xs="auto" className="d-flex flex-wrap gap-2">
                      <Link href={trashedHref} className="btn btn-soft-secondary" preserveScroll>
                        {filters.trashed ? "Active roles" : "Trash"}
                      </Link>
                      {!filters.trashed && (
                                    ...
                                    {!filters.trashed ? (
                                      <ul className="list-inline hstack gap-2 mb-0">
                                        <li className="list-inline-item">
                                          <Link
                                            href={route("admin.roles.show", r.id)}
                                      ...
                                      <Button
                                        ...
                                        onClick={() =>
                                          router.post(
                                            route("admin.roles.restore", r.id),
                                            {},
                                            { preserveScroll: true }
                                          )
                                        }
        ...
        >
          <Form onSubmit={submitDrawer}>
            <div className="mb-3">
              <Form.Label htmlFor="admin-role-name" className="form-label">
            ...
            <div className="mb-3">
              <Form.Label htmlFor="admin-role-slug" className="form-label">
                Slug
              </Form.Label>
              <Form.Control
                id="admin-role-slug"
              ...
              />
              {form.errors.slug && (
                <div className="text-danger small mt-1">{form.errors.slug}</div>
              )}
            </div>
            <div className="mb-3">
              <Form.Label htmlFor="admin-role-description" className="form-label">
                Short description
              </Form.Label>
              <Form.Control
              ...
              {form.errors.description && (
                <div className="text-danger small mt-1">{form.errors.description}</div>
              )}
            </div>
            <div className="d-flex gap-2 justify-content-end">
              <Button variant="light" type="button" onClick={closeDrawer}>
