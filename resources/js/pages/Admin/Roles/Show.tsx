  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Role details" pageTitle="Administration" />
            ...
            <Col xl={10}>
              <Card>
                <Card.Header className="d-flex flex-wrap align-items-center justify-content-between gap-2 border-0">
                  <div>
                    ...
                    <p className="text-muted small mb-0">
                      Read-only definition and assigned users.
                    </p>
                    {role.deleted_at && (
                ...
                <Card.Body>
                  <Row className="g-4">
                    <Col lg={7}>
                      <DetailRow label="Display name">{role.name}</DetailRow>
                      <DetailRow label="Slug">
                        <code className="small">{role.slug}</code>
                      </DetailRow>
                      ...
                      <DetailRow label="Created">{formatWhen(role.created_at)}</DetailRow>
                      <DetailRow label="Last updated">{formatWhen(role.updated_at)}</DetailRow>
                    </Col>
                    <Col lg={5}>
                      <Card className="border shadow-none bg-light bg-opacity-50">
                        <Card.Header className="bg-transparent border-0 pb-0">
                          <h6 className="mb-0">Assigned users</h6>
                          <p className="text-muted small mb-0">
                            Includes archived members for auditing.
                          </p>
                        </Card.Header>
