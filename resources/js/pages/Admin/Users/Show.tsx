  ...
  return (
    <React.Fragment>
      ...
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="User details" pageTitle="Administration" />
                ...
                <Card.Body>
                  <Row className="mb-4">
                    ...
                    <Col sm={9}>
                      ...
                      <DetailRow label="Bio">
                        {user.bio ? (
                          <span className="fw-normal text-body">{user.bio}</span>
                        ) : (
                          <span className="text-muted fw-normal">—</span>
                        )}
                      </DetailRow>
                      <DetailRow label="Created">{formatWhen(user.created_at)}</DetailRow>
                      <DetailRow label="Last updated">{formatWhen(user.updated_at)}</DetailRow>
                    </Col>
                  </Row>
                </Card.Body>
              </Card>
