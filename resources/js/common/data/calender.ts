...
const events = [
    ...
    },
    {
        ...
        start: new Date(y, m, d + 22, 20, 0).toISOString(),
        end: new Date(y, m, d + 24, 16, 0).toISOString(),
        allDay: false,
    ...
    },
    {
        ...
        end: new Date(y, m, d + 9, 16, 0).toISOString(),
        allDay: false,
        className: "bg-primary-subtle text-primary",
    ...
    },
    {
        ...
        start: new Date(y, m, d, 12, 30).toISOString(),
        allDay: false,
    ...
    },
    {
        ...
        start: new Date(y, m, d + 9).toISOString(),
        end: new Date(y, m, d + 11).toISOString(),
        allDay: false,
        className: "bg-danger-subtle text-danger",
        location: "Head Office, US",
        extendedProps: {
    ...
    },
    {
        ...
        start: new Date(y, m, d + 23, 20, 0).toISOString(),
        end: new Date(y, m, d + 24, 16, 0).toISOString(),
        allDay: false,
        className: "bg-info-subtle text-info",
        location: "Head Office, US",
