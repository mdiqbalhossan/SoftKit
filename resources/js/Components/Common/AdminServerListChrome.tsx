...
export function AdminTableEmptyState({ title, description }: AdminEmptyStateProps) {
  return (
...
export function AdminLoadingOverlay({ show, children }: AdminLoadingOverlayProps) {
  return (
    <div className="position-relative">
      {show && (
        <div
          className="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center rounded"
          style={{ zIndex: 3, minHeight: 120, background: "rgba(255,255,255,0.65)" }}
        >
...
export function AdminExportCsvModal({ show, onClose, data }: AdminExportCsvModalProps) {
