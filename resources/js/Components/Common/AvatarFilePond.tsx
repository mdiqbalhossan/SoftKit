...
export function AvatarFilePond({
    ...
    const helperText =
        variant === "site-favicon" ? (
            <>
                FilePond: PNG, SVG, ICO, or WebP. Browsers vary on ICO detection
                — invalid types are rejected when you save. Max 1&nbsp;MB.
            </>
        ) : variant === "site-logo" ? (
            <>
                FilePond optimizes images for upload. Used in sidebar and header
                — wide or square PNG works well. Max 4&nbsp;MB (PNG, JPG, GIF,
                WebP).
            </>
        ) : (
            <>
                FilePond optimizes images for upload. Use a square image for
                best results. Max 2&nbsp;MB (PNG, JPG, GIF, WebP).
            </>
        );
    ...
    return (
        <div className="mb-0">
            ...
            <FilePond
                ...
                acceptedFileTypes={
                    variant === "site-favicon" ? undefined : acceptedFileTypes
                }
                name={pondName}
                className={className}
